...
Why AQuA-RAT is included:
- Phase 1 SFT used all four datasets.
- RL should continue reinforcing algebraic step‑by‑step reasoning.
"""
...
class MultiDatasetSampler:
    ...
    Mix ratios (configurable):
        ...
        - StrategyQA: 25% (logical yes/no — weakest benchmark)
        ...
        try:
            ...
            for item in aqua_ds:
                ...
                aqua_questions.append({
                    "question": full_question,
                    "answer": item["correct"],   # Already "A", "B", "C", "D"
                    "dataset": "aqua",
                })
